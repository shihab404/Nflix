...
//suspend fun main() {
//    val providerTester = com.lagradost.cloudstreamtest.ProviderTester(NflixProvider())
...
class NflixMoviesProvider : MainAPI() {
    override var mainUrl = "http://nflix.netscopebd.com/series"
    private val apiUrl = "http://10.0.5.3"
    override var name = "Nflix"
